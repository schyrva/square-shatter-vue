...
export const useProductStore = defineStore("products", () => {
  ...
  const products = ref<Product[]>([
    ...
    },
    {
      ...
      description:
        "Designed for challenging terrains and mountain trails. Robust and reliable.",
      price: 2990,
    ...
    },
    {
      ...
      name: "Urban Commuter",
      description:
        "Perfect for daily commuting in the city. Lightweight and comfortable.",
      price: 1890,
    ...
    },
    {
      ...
      name: "Speed Pro",
      description:
        "Built for speed and efficiency on roads. Aerodynamic design for performance.",
      price: 3290,
