  ...
  const products = ref<Product[]>([
    {
      ...
      price: 2590,
      image: '/assets/landing/images/products/sporty-4.png',
      category: 'mountain',
      available: true,
      rating: 4,
    },
    {
      ...
      price: 2590,
      image: '/assets/landing/images/products/ride-in-town-st.png',
      category: 'urban',
      available: true,
      rating: 5,
    },
    {
      ...
      price: 2090,
      image: '/assets/landing/images/products/agile-ride-3.png',
      category: 'road',
      available: true,
      rating: 1,
    },
